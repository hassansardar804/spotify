...
import { FaUser , IoMusicalNotesOutline , GrUpload,   } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <div className="flex items-center">
          <FaUser className="text-blue-500 mr-4" size={32} />
          <div>
          ...
          <IoMusicalNotesOutline
            className="text-blue-500 ml-80 mr-4"
            size={32}
          />
          <div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <h2 className="text-xl font-semibold mb-4 flex items-center">
          <IoMusicalNotesOutline className="text-green-500 mr-2" size={24} />
          Manage Songs
        </h2>
        ...
        <form onSubmit={addSong} className="mb-4 grid grid-cols-2 gap-4">
          ...
          >
            <GrUpload size={20} className="mr-2" /> Upload Song
          </button>
        </form>
